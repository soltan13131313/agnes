                                ...
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?php if($i==0) echo "Starter"; elseif ($i==1)
                                                echo "Professional"; else echo "Business"; ?></div>
                                            <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2"><?php if($i==0) echo 27; elseif ($i==1)
                                                echo 97; else echo 147; ?></span>/mo</div>
                                        </div>
